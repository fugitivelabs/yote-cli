...
export const fetchSingleIfNeeded = (id) => (dispatch, getState) => {
  if (shouldFetchSingle(getState(), id)) {
    return dispatch(fetchSingle___PascalName___ById(id))
  } else {
    return dispatch(returnSingle___PascalName___Promise(id)); // return promise that contains __camelName__
  }
}


export const returnSingle___PascalName___Promise = (id) => (dispatch, getState) => {
  /**
...
function requestSingle___PascalName___(id) {
  return {
    id
...
function receiveSingle___PascalName___(json) {
  return {
    error: json.message
...
export function fetchSingle___PascalName___ById(id) {
  return dispatch => {
    dispatch(requestSingle___PascalName___(id))
    return apiUtils.callAPI(`/api/__camelName__s/${id}`)
      .then(json => dispatch(receiveSingle___PascalName___(json)))
  }
}

export const ADD_SINGLE___actionCase___TO_MAP = "ADD_SINGLE___actionCase___TO_MAP";
export function addSingle___PascalName___ToMap(item) {
  return {
    item
...
export const SET_SELECTED___actionCase__ = "SET_SELECTED___actionCase__";
export function setSelected___PascalName___(item) {
  return {
    type: SET_SELECTED___actionCase__
    , item
  }
}

export const REQUEST_DEFAULT___actionCase__ = "REQUEST_DEFAULT___actionCase__";
function requestDefault___PascalName___(id) {
  return {
    type: REQUEST_DEFAULT___actionCase__
  }
}

export const RECEIVE_DEFAULT___actionCase__ = "RECEIVE_DEFAULT___actionCase__";
function receiveDefault___PascalName___(json) {
  return {
    error: json.message
    , defaultObj: json.defaultObj
    , receivedAt: Date.now()
    , success: json.success
    , type: RECEIVE_DEFAULT___actionCase__
  }
}

export function fetchDefault___PascalName___() {
  return dispatch => {
    dispatch(requestDefault___PascalName___())
    return apiUtils.callAPI(`/api/__camelName__s/default`)
      .then(json => dispatch(receiveDefault___PascalName___(json)))
  }
}

export const REQUEST___actionCase___SCHEMA = "REQUEST___actionCase___SCHEMA";
function request___PascalName___Schema(id) {
  return {
    type: REQUEST___actionCase___SCHEMA
  }
}
 export const RECEIVE___actionCase___SCHEMA = "RECEIVE___actionCase___SCHEMA";
function receive___PascalName___Schema(json) {
  return {
    error: json.message
    , schema: json.schema
    , receivedAt: Date.now()
    , success: json.success
    , type: RECEIVE___actionCase___SCHEMA
  }
}
 export function fetch___PascalName___Schema() {
  return dispatch => {
    dispatch(request___PascalName___Schema())
    return apiUtils.callAPI(`/api/__camelName__s/schema`)
      .then(json => dispatch(receive___PascalName___Schema(json)))
  }
}

export const REQUEST_CREATE___actionCase__ = "REQUEST_CREATE___actionCase__";
function requestCreate___PascalName___(__camelName__) {
  return {
    __camelName__
...
function receiveCreate___PascalName___(json) {
  return {
    error: json.message
    , id: json.__camelName__ ? json.__camelName__._id : null
    , item: json.__camelName__
...
export function sendCreate___PascalName___(data) {
  return dispatch => {
    dispatch(requestCreate___PascalName___(data))
    return apiUtils.callAPI('/api/__camelName__s', 'POST', data)
      .then(json => dispatch(receiveCreate___PascalName___(json)))
  }
}

export const REQUEST_UPDATE___actionCase__ = "REQUEST_UPDATE___actionCase__";
function requestUpdate___PascalName___(__camelName__) {
  return {
...
function receiveUpdate___PascalName___(json) {
  return {
    error: json.message
    , id: json.__camelName__ ? json.__camelName__._id : null
    , item: json.__camelName__
...
export function sendUpdate___PascalName___(data) {
  return dispatch => {
    dispatch(requestUpdate___PascalName___(data))
    return apiUtils.callAPI(`/api/__camelName__s/${data._id}`, 'PUT', data)
      .then(json => dispatch(receiveUpdate___PascalName___(json)))
  }
}

export const REQUEST_DELETE___actionCase__ = "REQUEST_DELETE___actionCase__";
function requestDelete___PascalName___(id) {
  return {
    id
...
function receiveDelete___PascalName___(id, json) {
  return {
    error: json.message
    , id
    , receivedAt: Date.now()
...
export function sendDelete(id) {
  return dispatch => {
    dispatch(requestDelete___PascalName___(id))
    return apiUtils.callAPI(`/api/__camelName__s/${id}`, 'DELETE')
      .then(json => dispatch(receiveDelete___PascalName___(id, json)))
  }
}
...
export const fetchListIfNeeded = (...listArgs) => (dispatch, getState) => {
  ...
  if(shouldFetchList(getState(), listArgs)) {
    ...
    return dispatch(return___PascalName___ListPromise(...listArgs));
  }
}

export const return___PascalName___ListPromise = (...listArgs) => (dispatch, getState) => {
  /**
...
function request___PascalName___List(listArgs) {
  return {
    listArgs
...
function receive___PascalName___List(json, listArgs) {
  return {
    error: json.message
...
export function add___PascalName___ToList(item, ...listArgs) {
  if(listArgs.length === 0) {
    listArgs = ["all"];
  }
...
export function remove___PascalName___FromList(id, ...listArgs) {
  if(listArgs.length === 0) {
    listArgs = ['all'];
  }
  return {
...
export function fetchList(...listArgs) {
  return dispatch => {
    ...
    dispatch(request___PascalName___List(listArgs))
    /**
    ...
    return apiUtils.callAPI(apiTarget).then(
      json => dispatch(receive___PascalName___List(json, listArgs))
    )
  }
}
