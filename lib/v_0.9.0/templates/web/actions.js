...
export function fetchSingle__PascalName__ById(id) {
  return dispatch => {
    dispatch(requestSingle__PascalName__(id))
    return apiUtils.callAPI(`/api/__kebabNamePlural__/${id}`)
...
export function add__PascalName__ToList(item, ...listArgs) {
  if(listArgs.length === 0) {
    listArgs = ["all"];
  }
