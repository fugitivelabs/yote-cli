...
module.exports = function(resourceName, options) {
  ...
  var clientPath = "./web/resources/" + camelName + '/admin';
  ...
  utils.append(`./web/resources/${camelName}/${camelName}GlobalStyles.scss`, sassRef);

  var routesRef = `\nexport { default as ${camelNamePlural} } from '../resources/${camelName}/admin/${PascalName}AdminRouter.js.jsx';`
  utils.append("./web/config/adminResourceRoutes.js", routesRef);

  var navRef = `  , { path: '/admin/${kebabNamePlural}', display: '${PascalName}s' } \n];`;
  utils.replaceInFile('./web/config/adminNavItems.js', '];', navRef);
