...
module.exports = function(resourceName) {
  ...
  var serverPath = "./server/api/resources/" + camelName;
  ...
  utils.append("./server/api/api-router.js", newApiReference);

  var newDbReference  = "\nlet " + PascalName + " = require('./api/resources/" + camelName + "/" + PascalName + "Model');";
