...
.factory('__Proper__Factory', ['$http', '$q', function($http, $q) {
  ...
  *************************************************************************************/
  ...
  // __Proper__Factory.update = function(__name__Data) {
  //   console.log("attempting to update __name__ with id " + __name__Data.id + " in factory");
  //   var deferred = $q.defer();
  //   $http.put(urlBase + '/' + __name__Data.id, __name__Data)
  //     .success(function(data) {
  //       if(data.success) {
  //         console.log("it worked!");
  //         console.log(data);
  ...
  // //   console.log("attempting to delete __name__ with id " + __name__Data.id + "in factory");
  // //   var deferred = $q.defer();
  // //   $http.delete(urlBase + '/' + __name__Data.id)
  // //     .success(function(data) {
  // //       if(data.success) {
  // //         console.log("it worked!");
  // //         console.log(data);
