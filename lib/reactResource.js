  ...
  if(checkClient) {
    ...
    mkdir(clientPath, function() {
      mkdir(clientPath + '/actions', function() {
        write(clientPath + '/actions/index.js', readTemplate(v + '/client/actions/index.js'));
        write(clientPath + '/actions/' + name + 'ListActions.js', readTemplate(v + '/client/actions/listActions.js'));
        write(clientPath + '/actions/' + name + 'SingleActions.js', readTemplate(v + '/client/actions/singleActions.js'));
      })
      ...
      mkdir(clientPath + '/reducers', function() {
        write(clientPath + '/reducers/index.js', readTemplate(v + '/client/reducers/index.js'));
        write(clientPath + '/reducers/' + name + 'ListReducers.js', readTemplate(v + '/client/reducers/listReducers.js'));
        write(clientPath + '/reducers/' + name + 'SingleReducers.js', readTemplate(v + '/client/reducers/singleReducers.js'));
      })
