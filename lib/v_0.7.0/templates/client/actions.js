...
export function fetchList(...listArgs) {
  return dispatch => {
     ...
     *  if 2nd arg is a string, return "/api/__name__s/by-[ARG1]/[ARG2]".
     *    ex: /api/__name__s/by-category/:category
     *  if 2nd arg is an array, though, return "/api/__name__s/by-[ARG1]-list" with additional query string
     *
    ...
    if(listArgs.length == 1 && listArgs[0] !== "all") {
      ...
      // this can be used for querying for a list of __name__s given an array of __name__s id's, among other things
