...
function __name__List(state = {
  ...
  if(nextAction.listArgs.length > 0) {
     ...
     */
    switch(action.type) {
      case Actions.INVALIDATE___actionCase__LIST: {
        return Object.assign({}, state, {
          didInvalidate: true
        })
      }
      case Actions.REQUEST___actionCase__LIST: {
        return Object.assign({}, state, {
          items: [] // array of _id's
          , isFetching: true
          , error: null
      ...
      case Actions.RECEIVE___actionCase__LIST: {
        if(!action.success) {
          return Object.assign({}, state, {
            items: [] // array of _id's
            , isFetching: false
      ...
      case Actions.SET___actionCase__FILTER: {
        return Object.assign({}, state, {
          filter: action.filter
        })
      }
      case Actions.SET___actionCase__PAGINATION: {
        return Object.assign({}, state, {
...
function __name__(state = {
  ...
  switch(action.type) {
    /**
     * SINGLE __actionCase_ ACTIONS
     */
    case Actions.REQUEST_SINGLE___actionCase_: {
    ...
    case Actions.RECEIVE_SINGLE___actionCase_: {
      if(action.success) {
    ...
    case Actions.ADD_SINGLE___actionCase__TO_MAP: {
    ...
    case Actions.REQUEST_CREATE___actionCase_: {
      nextState = Object.assign({}, state, {
        selected: {
          id: null
          , isFetching: true
    ...
    case Actions.RECEIVE_CREATE___actionCase_: {
      if(action.success) {
        // add received object to map
        let newIdMap = Object.assign({}, state.byId, {});
        newIdMap[action.id] = action.item;
    ...
    case Actions.REQUEST_UPDATE___actionCase_: {
      nextState = Object.assign({}, state, {
        selected: {
          id: action.id
          , isFetching: true
    ...
    case Actions.RECEIVE_UPDATE___actionCase_: {
      if(action.success) {
        // add received object to map
        let newIdMap = Object.assign({}, state.byId, {});
        newIdMap[action.id] = action.item;
    ...
    case Actions.REQUEST_DELETE___actionCase_: {
      nextState = Object.assign({}, state, {
        selected: {
          id: action.id
          , isFetching: true
    ...
    case Actions.RECEIVE_DELETE___actionCase_: {
      if(action.success) {
    ...
    case Actions.INVALIDATE_SELECTED___actionCase_: {
      nextState = Object.assign({}, state, {
        selected: {
          didInvalidate: true
        }
