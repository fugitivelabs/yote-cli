...
module.exports = function(resourceName, options) {
  ...
  if(!utils.checkIfExists('./yote-project.json')) {
    console.log(chak.bgRed("No yote-project.json file present! Please make sure you are in the project top-level directory and that you have initialized the project correctly."));
    return;
  }
