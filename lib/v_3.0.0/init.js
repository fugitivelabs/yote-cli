...
module.exports = function(appName, options) {
  ...
  let installOptions = ["web","server","mobile"];
  ...
  let branch = "3";
  // let branch = "master";
  shell.exec(`git clone -b ${branch} --depth=1 https://github.com/fugitivelabs/yote.git ${appName}`);
  shell.exec(`rm -r "./${appName}/.git"`);
  //
  ...
  if(!installOptions.indexOf('server') < 0) {
    ...
    console.log();
    shell.cd("server");
    shell.sed('-i', `yote`, appName, [`./config/default.js`, `./config/development.js`, `./config/staging.js`, `./config/production.js`]);
   ...
   */
  if(!installOptions.indexOf('web') < 0) {
    console.log();
    console.log();
    console.log(chalk.bgCyan('////////////////////////////////////////////////////////'));
    console.log();
    console.log("Removing Web component");
    console.log();
    console.log(chalk.bgCyan('////////////////////////////////////////////////////////'));
    console.log();
    ...
    console.log(chalk.bgCyan('////////////////////////////////////////////////////////'));
    console.log();
    console.log(chalk.cyan("     Initializing Yote web for " + appName + ". "));
    console.log(chalk.cyan("     This may take a little while..."));
    console.log();
    console.log(chalk.bgCyan('////////////////////////////////////////////////////////'));
    console.log();
    ...
    console.log(chalk.bgMagenta('////////////////////////////////////////////////////////'));
    console.log();
    console.log(chalk.magenta("     Finished with " + appName + " web "));
    console.log();
    console.log(chalk.bgMagenta('////////////////////////////////////////////////////////'));
    console.log();
  }
  ...
  if(!installOptions.indexOf('mobile') < 0) {
    ...
    console.log(chalk.bgMagenta('////////////////////////////////////////////////////////'));
    console.log();
    console.log(chalk.magenta("     Finished creating " + appName + " mobile web "))
    console.log();
    console.log(chalk.bgMagenta('////////////////////////////////////////////////////////'));
    console.log();
    shell.cd("..");
  ...
  console.log(chalk.green("         $ yote run --all"));
  console.log('');
  console.log(chalk.magenta("     To setup your git repository:"));
  console.log('');
  console.log(chalk.magenta("         - Create a git repository"));
  console.log(chalk.magenta("         - $ cd " + appName));
  console.log(chalk.magenta("         - $ git init; git add ."));
  console.log(chalk.magenta("         - $ git commit -a -m'initial yote commit'\n"));
  console.log(chalk.magenta("         - Create a your repository on https://github.com"));
