...
export function fetchSingle__PascalName__ById(__camelName__Id) {
  return dispatch => {
    ...
    return callAPI(`/api/__kebabNamePlural__/${__camelName__Id}`)
...
export function sendCreate__PascalName__(data) {
  return dispatch => {
    ...
    return callAPI('/api/__kebabNamePlural__', 'POST', data)
...
export function sendUpdate__PascalName__(data) {
  return dispatch => {
    ...
    return callAPI(`/api/__kebabNamePlural__/${data._id}`, 'PUT', data)
...
export function sendDelete(id) {
  return dispatch => {
    ...
    return callAPI(`/api/__kebabNamePlural__/${id}`, 'DELETE')
