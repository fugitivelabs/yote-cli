...
export function fetchSingle__PascalName__ById(__name__Id) {
  return dispatch => {
    ...
    return callAPI(`/api/__kebabNamePlural__/${__name__Id}`)
...
export function fetchList(...listArgs) {
  return dispatch => {
    ...
    if(listArgs.length == 1 && listArgs[0] !== "all") {
      ...
      // this can be used for querying for a list of __camelNamePlural__ given an array of __name__ id's, among other things
