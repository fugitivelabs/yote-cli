...
class __PascalName__List extends Base {
  ...
  componentWillReceiveProps(nextProps) {
    if(this.props.__camelNamePlural__ !== nextProps.__camelNamePlural__ || this.props.__camelName__Map !== nextProps.__camelName__Map) {
      this.setState({
  ...
  _renderRow(__camelName__Id) {
    ...
    return (
      <__PascalName__ListItem
        __camelName__={__camelName__Map[__camelName__Id]}
